...
null_zombiecount_with_valid_terminatorcount_status="$(curl -sS -o /tmp/rpc-zombie-smoke-null-zombiecount-with-valid-terminatorcount.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"NullZombieCountWithValidTerminatorCountSmoke","zombieCount":null,"terminatorCount":4}')"
...
both_null_count_aliases_status="$(curl -sS -o /tmp/rpc-zombie-smoke-both-null-count-aliases.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"BothNullCountAliasesSmoke","zombieCount":null,"terminatorCount":null}')"
null_zombiecount_with_out_of_range_terminatorcount_status="$(curl -sS -o /tmp/rpc-zombie-smoke-null-zombiecount-with-out-of-range-terminatorcount.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"NullZombieCountWithOutOfRangeTerminatorCountSmoke","zombieCount":null,"terminatorCount":33}')"
...
null_zombiecount_with_low_terminatorcount_status="$(curl -sS -o /tmp/rpc-zombie-smoke-null-zombiecount-with-low-terminatorcount.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"NullZombieCountWithLowTerminatorCountSmoke","zombieCount":null,"terminatorCount":0}')"
null_terminatorcount_with_low_zombiecount_status="$(curl -sS -o /tmp/rpc-zombie-smoke-null-terminatorcount-with-low-zombiecount.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"NullTerminatorCountWithLowZombieCountSmoke","zombieCount":0,"terminatorCount":null}')"
null_zombiecount_with_negative_terminatorcount_status="$(curl -sS -o /tmp/rpc-zombie-smoke-null-zombiecount-with-negative-terminatorcount.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"NullZombieCountWithNegativeTerminatorCountSmoke","zombieCount":null,"terminatorCount":-1}')"
null_terminatorcount_with_negative_zombiecount_status="$(curl -sS -o /tmp/rpc-zombie-smoke-null-terminatorcount-with-negative-zombiecount.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"NullTerminatorCountWithNegativeZombieCountSmoke","zombieCount":-1,"terminatorCount":null}')"
...
null_zombiecount_with_invalid_terminatorcount_type_status="$(curl -sS -o /tmp/rpc-zombie-smoke-null-zombiecount-with-invalid-terminatorcount-type.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"NullZombieCountWithInvalidTerminatorCountTypeSmoke","zombieCount":null,"terminatorCount":"4"}')"
null_terminatorcount_with_invalid_zombiecount_type_status="$(curl -sS -o /tmp/rpc-zombie-smoke-null-terminatorcount-with-invalid-zombiecount-type.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"NullTerminatorCountWithInvalidZombieCountTypeSmoke","zombieCount":"4","terminatorCount":null}')"
...
matching_low_count_aliases_status="$(curl -sS -o /tmp/rpc-zombie-smoke-matching-low-count-aliases-join.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"MatchingLowCountAliasesSmoke","zombieCount":0,"terminatorCount":0}')"
matching_negative_count_aliases_status="$(curl -sS -o /tmp/rpc-zombie-smoke-matching-negative-count-aliases-join.json -w "%{http_code}" -X POST "${BASE_URL}/api/game/join" \
  -H "Content-Type: application/json" \
  -d '{"playerName":"MatchingNegativeCountAliasesSmoke","zombieCount":-1,"terminatorCount":-1}')"
...
python3 - <<'PY' "${null_zombiecount_with_valid_terminatorcount_status}" "${null_terminatorcount_with_valid_zombiecount_status}" "${null_zombiecount_without_terminatorcount_status}" "${null_terminatorcount_without_zombiecount_status}" "${both_null_count_aliases_status}" "${null_zombiecount_with_out_of_range_terminatorcount_status}" "${null_terminatorcount_with_out_of_range_zombiecount_status}" "${null_zombiecount_with_low_terminatorcount_status}" "${null_terminatorcount_with_low_zombiecount_status}" "${null_zombiecount_with_negative_terminatorcount_status}" "${null_terminatorcount_with_negative_zombiecount_status}" "${null_zombiecount_with_fractional_terminatorcount_status}" "${null_terminatorcount_with_fractional_zombiecount_status}" "${null_zombiecount_with_invalid_terminatorcount_type_status}" "${null_terminatorcount_with_invalid_zombiecount_type_status}"
import json
import pathlib
import sys
...
null_zombiecount_with_low_terminatorcount_status = int(sys.argv[8])
null_terminatorcount_with_low_zombiecount_status = int(sys.argv[9])
null_zombiecount_with_negative_terminatorcount_status = int(sys.argv[10])
null_terminatorcount_with_negative_zombiecount_status = int(sys.argv[11])
null_zombiecount_with_fractional_terminatorcount_status = int(sys.argv[12])
null_terminatorcount_with_fractional_zombiecount_status = int(sys.argv[13])
null_zombiecount_with_invalid_terminatorcount_type_status = int(sys.argv[14])
null_terminatorcount_with_invalid_zombiecount_type_status = int(sys.argv[15])
...
both_null_count_aliases_payload = json.loads(
    pathlib.Path("/tmp/rpc-zombie-smoke-both-null-count-aliases.json").read_text()
)
null_zombiecount_with_out_of_range_terminatorcount_payload = json.loads(
    pathlib.Path("/tmp/rpc-zombie-smoke-null-zombiecount-with-out-of-range-terminatorcount.json").read_text()
)
...
null_zombiecount_with_low_terminatorcount_payload = json.loads(
    pathlib.Path("/tmp/rpc-zombie-smoke-null-zombiecount-with-low-terminatorcount.json").read_text()
)
null_terminatorcount_with_low_zombiecount_payload = json.loads(
    pathlib.Path("/tmp/rpc-zombie-smoke-null-terminatorcount-with-low-zombiecount.json").read_text()
)
null_zombiecount_with_negative_terminatorcount_payload = json.loads(
    pathlib.Path("/tmp/rpc-zombie-smoke-null-zombiecount-with-negative-terminatorcount.json").read_text()
)
null_terminatorcount_with_negative_zombiecount_payload = json.loads(
    pathlib.Path("/tmp/rpc-zombie-smoke-null-terminatorcount-with-negative-zombiecount.json").read_text()
)
...
null_zombiecount_with_invalid_terminatorcount_type_payload = json.loads(
    pathlib.Path("/tmp/rpc-zombie-smoke-null-zombiecount-with-invalid-terminatorcount-type.json").read_text()
)
null_terminatorcount_with_invalid_zombiecount_type_payload = json.loads(
    pathlib.Path("/tmp/rpc-zombie-smoke-null-terminatorcount-with-invalid-zombiecount-type.json").read_text()
)

assert null_zombiecount_with_valid_terminatorcount_status == 400, (
    "null zombieCount with valid terminatorCount join should be 400, "
    f"got {null_zombiecount_with_valid_terminatorcount_status}"
)
assert null_zombiecount_with_valid_terminatorcount_payload["ok"] is False, (
    "null zombieCount with valid terminatorCount join payload should fail"
)
assert null_zombiecount_with_valid_terminatorcount_payload["error"]["code"] == "INVALID_FIELD", (
    "null zombieCount with valid terminatorCount join code mismatch: "
    f"{null_zombiecount_with_valid_terminatorcount_payload['error']['code']}"
)
assert null_terminatorcount_with_valid_zombiecount_status == 400, (
    "null terminatorCount with valid zombieCount join should be 400, "
    f"got {null_terminatorcount_with_valid_zombiecount_status}"
)
assert null_terminatorcount_with_valid_zombiecount_payload["ok"] is False, (
    "null terminatorCount with valid zombieCount join payload should fail"
)
...
assert both_null_count_aliases_status == 400, (
    "both null zombieCount and terminatorCount join should be 400, "
    f"got {both_null_count_aliases_status}"
)
assert both_null_count_aliases_payload["ok"] is False, (
    "both null count aliases join payload should fail"
)
assert both_null_count_aliases_payload["error"]["code"] == "INVALID_FIELD", (
    "both null count aliases join code mismatch: "
    f"{both_null_count_aliases_payload['error']['code']}"
)
assert null_zombiecount_with_out_of_range_terminatorcount_status == 400, (
    "null zombieCount with out-of-range terminatorCount join should be 400, "
    f"got {null_zombiecount_with_out_of_range_terminatorcount_status}"
)
assert null_zombiecount_with_out_of_range_terminatorcount_payload["ok"] is False, (
    "null zombieCount with out-of-range terminatorCount join payload should fail"
)
assert null_zombiecount_with_out_of_range_terminatorcount_payload["error"]["code"] == "INVALID_FIELD", (
    "null zombieCount with out-of-range terminatorCount join code mismatch: "
    f"{null_zombiecount_with_out_of_range_terminatorcount_payload['error']['code']}"
)
assert null_terminatorcount_with_out_of_range_zombiecount_status == 400, (
    "null terminatorCount with out-of-range zombieCount join should be 400, "
    f"got {null_terminatorcount_with_out_of_range_zombiecount_status}"
)
assert null_terminatorcount_with_out_of_range_zombiecount_payload["ok"] is False, (
    "null terminatorCount with out-of-range zombieCount join payload should fail"
)
...
assert null_zombiecount_with_low_terminatorcount_status == 400, (
    "null zombieCount with low terminatorCount join should be 400, "
    f"got {null_zombiecount_with_low_terminatorcount_status}"
)
assert null_zombiecount_with_low_terminatorcount_payload["ok"] is False, (
    "null zombieCount with low terminatorCount join payload should fail"
)
assert null_zombiecount_with_low_terminatorcount_payload["error"]["code"] == "INVALID_FIELD", (
    "null zombieCount with low terminatorCount join code mismatch: "
    f"{null_zombiecount_with_low_terminatorcount_payload['error']['code']}"
)
assert null_terminatorcount_with_low_zombiecount_status == 400, (
    "null terminatorCount with low zombieCount join should be 400, "
    f"got {null_terminatorcount_with_low_zombiecount_status}"
)
assert null_terminatorcount_with_low_zombiecount_payload["ok"] is False, (
    "null terminatorCount with low zombieCount join payload should fail"
)
assert null_terminatorcount_with_low_zombiecount_payload["error"]["code"] == "INVALID_FIELD", (
    "null terminatorCount with low zombieCount join code mismatch: "
    f"{null_terminatorcount_with_low_zombiecount_payload['error']['code']}"
)
assert null_zombiecount_with_negative_terminatorcount_status == 400, (
    "null zombieCount with negative terminatorCount join should be 400, "
    f"got {null_zombiecount_with_negative_terminatorcount_status}"
)
assert null_zombiecount_with_negative_terminatorcount_payload["ok"] is False, (
    "null zombieCount with negative terminatorCount join payload should fail"
)
assert null_zombiecount_with_negative_terminatorcount_payload["error"]["code"] == "INVALID_FIELD", (
    "null zombieCount with negative terminatorCount join code mismatch: "
    f"{null_zombiecount_with_negative_terminatorcount_payload['error']['code']}"
)
assert null_terminatorcount_with_negative_zombiecount_status == 400, (
    "null terminatorCount with negative zombieCount join should be 400, "
    f"got {null_terminatorcount_with_negative_zombiecount_status}"
)
assert null_terminatorcount_with_negative_zombiecount_payload["ok"] is False, (
    "null terminatorCount with negative zombieCount join payload should fail"
)
assert null_terminatorcount_with_negative_zombiecount_payload["error"]["code"] == "INVALID_FIELD", (
    "null terminatorCount with negative zombieCount join code mismatch: "
    f"{null_terminatorcount_with_negative_zombiecount_payload['error']['code']}"
)
...
assert null_zombiecount_with_invalid_terminatorcount_type_status == 400, (
    "null zombieCount with invalid terminatorCount type join should be 400, "
    f"got {null_zombiecount_with_invalid_terminatorcount_type_status}"
)
assert null_zombiecount_with_invalid_terminatorcount_type_payload["ok"] is False, (
    "null zombieCount with invalid terminatorCount type join payload should fail"
)
assert null_zombiecount_with_invalid_terminatorcount_type_payload["error"]["code"] == "INVALID_FIELD", (
    "null zombieCount with invalid terminatorCount type join code mismatch: "
    f"{null_zombiecount_with_invalid_terminatorcount_type_payload['error']['code']}"
)
assert null_terminatorcount_with_invalid_zombiecount_type_status == 400, (
    "null terminatorCount with invalid zombieCount type join should be 400, "
    f"got {null_terminatorcount_with_invalid_zombiecount_type_status}"
)
assert null_terminatorcount_with_invalid_zombiecount_type_payload["ok"] is False, (
    "null terminatorCount with invalid zombieCount type join payload should fail"
)
...
matching_negative_count_aliases_payload = json.loads(
    pathlib.Path("/tmp/rpc-zombie-smoke-matching-negative-count-aliases-join.json").read_text()
)
...
assert matching_low_count_aliases_status == 400, (
    "matching low zombieCount and terminatorCount join should be 400, "
    f"got {matching_low_count_aliases_status}"
)
assert matching_low_count_aliases_payload["ok"] is False, (
    "matching low count aliases join payload should fail"
)
assert matching_low_count_aliases_payload["error"]["code"] == "INVALID_ZOMBIE_COUNT", (
    "matching low count aliases join code mismatch: "
    f"{matching_low_count_aliases_payload['error']['code']}"
)
assert matching_negative_count_aliases_status == 400, (
    "matching negative zombieCount and terminatorCount join should be 400, "
    f"got {matching_negative_count_aliases_status}"
)
assert matching_negative_count_aliases_payload["ok"] is False, (
    "matching negative count aliases join payload should fail"
)
assert matching_negative_count_aliases_payload["error"]["code"] == "INVALID_ZOMBIE_COUNT", (
    "matching negative count aliases join code mismatch: "
    f"{matching_negative_count_aliases_payload['error']['code']}"
)
assert matching_fractional_count_aliases_status == 400, (
    "matching fractional zombieCount and terminatorCount join should be 400, "
    f"got {matching_fractional_count_aliases_status}"
)
assert matching_fractional_count_aliases_payload["ok"] is False, (
    "matching fractional count aliases join payload should fail"
)
