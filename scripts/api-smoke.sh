...
missing_state_status = int(sys.argv[16])
missing_observe_status = int(sys.argv[17])
blank_observe_player_status = int(sys.argv[18])
join_server_status = int(sys.argv[19])
invalid_server_join_field_status = int(sys.argv[20])
blank_server_join_player_id_status = int(sys.argv[21])
missing_server_status = int(sys.argv[22])
missing_join_server_status = int(sys.argv[23])
mismatch_join_status = int(sys.argv[24])
