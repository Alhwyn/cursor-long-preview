...
null_zombiecount_with_fractional_terminatorcount_start_status = int(sys.argv[8])
null_terminatorcount_with_fractional_zombiecount_start_status = int(sys.argv[9])
